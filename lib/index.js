...
if (core_1.default) {
    ...
    let repo_source = core_1.default.getInput("repo_source") || github_1.default.context.repo.owner + '/' + github_1.default.context.repo.repo;
    owner_source = repo_source.split('/')[0];
    repo_source = repo_source.split('/')[1];
    let repo_target = core_1.default.getInput("repo_target");
...
labelSyncer_1.LabelSyncer.syncLabels(octokit, owner_source, repo_source, owner_target, repo_target).then(() => console.log("Successfully synced labels"));
